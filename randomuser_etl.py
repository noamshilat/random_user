...
randomuser_api = "https://randomuser.me/api/?results=4500&noinfo&fmt=prettyjson"
...
limit 20)
'''
Noam_test_5_query = "select * from interview.Noam_test_5"

Noam_test_2_query = "select * from interview.Noam_test_2"


if __name__ == "__main__":

    # Extract the data (JSON format) from randomuser.me api service  
    data = requests.get(randomuser_api).json()[json_data_key]
    ...
    Noam_test_20 = pd.read_sql_query(top_20_last_registered_query,con=connect_to_db())
    ...
    Noam_test_5 = pd.read_sql_query(Noam_test_5_query,con=connect_to_db())
    ...
    # Write the new dataframe to a json file
    Noam_test_2 = pd.read_sql_query(Noam_test_2_query,con=connect_to_db())
